...
import { IAssignment } from "../vite-env";
import useError from "../hooks/useError";

const Assignment = () => {
  const [data, setData] = React.useState<IAssignment[]>([
    {
      assignmentId: 0,
      customerId: 0,
      employeeId: 0,
  ...
  React.useEffect(() => {
    const requestData = async () => {
      try {
        const response = await baseRegisterUrl.get("/assignments");
